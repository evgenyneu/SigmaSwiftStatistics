Pod::Spec.new do |s|
  ...
  s.summary     = "A collection of functions for statistical calculation written Swift for iOS, OS X, watchOS and tvOS."
  s.description  = <<-DESC
                   This library is a collection of functions that perform statistical calculations: average, covariance, max, min, pearson, percentile, standard deviation, sum, variance.
                   DESC
