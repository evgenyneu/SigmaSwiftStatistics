...
This library is a collection of functions that perform statistical calculations in Swift. It can in Swift apps on both Apple devices and open source Swift programs on other platforms.
