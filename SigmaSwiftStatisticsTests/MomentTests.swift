...
class MomentTests: XCTestCase {
  ...
  func testMoment0() {
    ...
    let moment = 0
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(1.0, result, accuracy: 0.000000000000001)
    }
    else {
      XCTAssertNil(nil)
    }
  ...
  func testMoment1() {
    ...
    let moment = 1
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(0.0, result, accuracy: 0.000000000000001)
    }
    else {
      XCTAssertNil(nil)
    }
  ...
  func testMoment2() {
    ...
    let moment = 2
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(0.077722199012376397, result, accuracy: 0.000000000000001)
    }
    else {
      XCTAssertNil(nil)
    }
  ...
  func testMoment3() {
    ...
    let moment = 3
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(0.0013903598882142676, result, accuracy: 0.000000000000001)
    }
    else {
      XCTAssertNil(nil)
    }
  ...
  func testMoment4() {
    ...
    let moment = 4
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(0.011763602339155939, result, accuracy: 0.000000000000001)
    }
    else {
      XCTAssertNil(nil)
    }
  ...
  func testMomentSingle() {
    let data_array: [Double] = [-99.999]
    let moment = 2
    if let result = Sigma.moment(data_array, m: moment) {
      XCTAssertEqualWithAccuracy(0.0, result, accuracy: 0.000000000000001)
    }
